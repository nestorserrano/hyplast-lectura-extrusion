...
@section('content')
    <div class="col-lg-8 offset-lg-2">
        <div class="card card-info">
            <div class="card-header">
                <div style="display: flex; justify-content: space-between; align-items: center;">
                    ...
                    <div class="pull-right">
                        <a href="{{ route('products') }}" class="btn btn-dark btn-sm float-right" data-toggle="tooltip" data-placement="left" title="{{ trans('hyplast.tooltips.back-products') }}">
            ...
            {!! Form::open(array('route' => 'products', 'method' => 'POST', 'role' => 'form', 'class' => 'needs-validation', 'files' => 'true', 'enctype' => 'multipart/form-data')) !!}
            {!! csrf_field() !!}
                ...
                <div class="row align-items-center">
                        ...
                        <div class="form-group has-feedback row {{ $errors->has('code') ? ' has-error ' : '' }}">
                            ...
                            <div class="col-md-9">
                                <div class="input-group">
                                    {!! Form::text('code', old('code'), array('id' => 'code', 'class' => 'form-control', 'placeholder' => trans('forms.create_product_ph_code'))) !!}
                    ...
                    <div class="col-sm-6 align-self-center">
                        <div class="form-group has-feedback row {{ $errors->has('name') ? ' has-error ' : '' }}">
                            ...
                            <div class="col-md-9">
                                <div class="input-group">
                                    {!! Form::text('name', old('name'), array('id' => 'name', 'class' => 'form-control', 'placeholder' => trans('forms.create_product_ph_name'))) !!}
                                    <div class="input-group-append">
                                ...
                                <div class="input-group">
                                    <select class="custom-select form-control" name="aplication_id" id="aplication_id" required="true">
                                        ...
                                        @foreach ($aplications as $aplication)
                                            @if (old('aplication_id') == $aplication->id)
                                ...
                                <div class="input-group">
                                    <select class="custom-select form-control" name="familyproduct_id" id="familyproduct_id" required="true">
                                        ...
                                        @foreach ($familyproducts as $familyproduct)
                                            @if (old('familyproduct_id') == $familyproduct->id)
                                ...
                                <div class="input-group">
                                    <select class="custom-select form-control" name="subproduct_id" id="subproduct_id" required="true">
                                        ...
                                        @foreach ($subproducts as $subproduct)
                                            @if (old('subproduct_id') == $subproduct->id)
                ...
                <div class="row align-items-center">
                    <div class="col-sm-5 align-self-center">
                        <div class="form-group has-feedback row {{ $errors->has('barcode') ? ' has-error ' : '' }}">
                            ...
                            <div class="col-md-7">
                                <div class="input-group">
                                    {!! Form::text('barcode', old('barcode'), array('id' => 'barcode', 'class' => 'form-control', 'placeholder' => trans('forms.create_product_ph_barcode'))) !!}
                                    <div class="input-group-append">
                    ...
                    <div class="col-sm-4 align-self-center">
                        <div class="form-group has-feedback row {{ $errors->has('caliber') ? ' has-error ' : '' }}">
                            ...
                            <div class="col-md-6">
                                <div class="input-group">
                                    {!! Form::text('caliber_lamination', old('caliber'), array('id' => 'caliber_lamination', 'class' => 'form-control', 'placeholder' => trans('forms.create_extruder_ph_caliber'))) !!}
                                    <div class="input-group-append">
                    ...
                    <div class="col-sm-3 align-self-center">
                        <div class="form-group has-feedback row {{ $errors->has('width_lamination') ? ' has-error ' : '' }}">
                            ...
                            <div class="col-md-8">
                                <div class="input-group">
                                    {!! Form::text('width_lamination', old('width_lamination'), array('id' => 'width_lamination', 'class' => 'form-control', 'placeholder' => trans('forms.create_product_ph_width'))) !!}
                                    <div class="input-group-append">
                                ...
                                <div class="input-group">
                                    <select class="custom-select form-control" name="capacity_id" id="capacity_id" required="true">
                                        ...
                                        @foreach ($capacities as $capacity)
                                            @if (old('capacity_id') == $capacity->id)
                                ...
                                <div class="input-group">
                                    <select class="custom-select form-control" name="diameter_id" id="diameter_id" required="true">
                                        ...
                                        @foreach ($diameters as $diameter)
                                            @if (old('diameter_id') == $diameter->id)
            ...
            <div class="card-body">
                <div class="form-group has-feedback row {{ $errors->has('composition') ? ' has-error ' : '' }}">
                    ...
                    <div class="col-sm-10 align-self-center">
                        <div class="input-group">
                            {!! Form::text('composition', old('composition'), array('id' => 'composition', 'class' => 'form-control', 'placeholder' => trans('forms.create_product_ph_composition'))) !!}
                            <div class="input-group-append">
                ...
                <div class="form-group has-feedback row {{ $errors->has('raw_material') ? ' has-error ' : '' }}">
                    ...
                    <div class="col-sm-10 align-self-center">
                        <div class="input-group">
                            {!! Form::textarea('raw_material',  old('raw_material'),array( 'rows' => 3, 'id' => 'raw_material', 'class' => 'form-control', 'placeholder' => trans('forms.create_product_ph_raw_material'))) !!}
                            <div class="input-group-append">
                ...
                <div class="form-group has-feedback row {{ $errors->has('useful_life') ? ' has-error ' : '' }}">
                    ...
                    <div class="col-sm-10 align-self-center">
                        <div class="input-group">
                            {!! Form::textarea('useful_life', old('useful_life'),array('rows' => 3, 'id' => 'useful_life', 'class' => 'form-control', 'placeholder' => trans('forms.create_product_ph_useful_life'))) !!}
                            <div class="input-group-append">
        ...
        <div class="card card-info">
            ...
            <div class="card-body">
                <table>
                    <tbody>
                        <tr>
                            <td align="center"><img id="imagenPrevisualizacion1" src="{!! asset('images/' . old('picture1')) !!}" style="width: 200px; align:center;" alt="{{ old('picture1') }}"></td>
                            <td align="center"><img id="imagenPrevisualizacion2" src="{!! asset('images/' . old('picture2')) !!}" style="width: 200px; align:center;" alt="{{ old('picture2') }}"></td>
                        </tr>
                        <tr>
                            <td>
                    ...
                    <div class="card card-info">
                        ...
                        <div class="card-body">
                            <div class="form-group has-feedback row {{ $errors->has('unit_weight') ? ' has-error ' : '' }}">
                                ...
                                <div class="col align-self-center">
                                    <div class="input-group">
                                        {!! Form::text('unit_weight', old('unit_weight'), array('id' => 'unit_weight', 'class' => 'form-control', 'placeholder' => trans('forms.create_product_ph_unit_weight'))) !!}
                                        <div class="input-group-append">
                                            <label class="input-group-text" for="name">
                            ...
                            <div class="form-group has-feedback row {{ $errors->has('net_weight') ? ' has-error ' : '' }}">
                                ...
                                <div class="col align-self-center">
                                    <div class="input-group">
                                        {!! Form::text('net_weight', old('net_weight'), array('id' => 'weight', 'class' => 'form-control', 'placeholder' => trans('forms.create_product_ph_net_weight'), 'required')) !!}
                                        <div class="input-group-append">
                                            <label class="input-group-text" for="name">
                            ...
                            <div class="form-group has-feedback row {{ $errors->has('gross_weight') ? ' has-error ' : '' }}">
                                ...
                                <div class="col align-self-center">
                                    <div class="input-group">
                                        {!! Form::text('gross_weight', old('gross_weight'), array('id' => 'gross_weight', 'class' => 'form-control', 'placeholder' => trans('forms.create_product_ph_gross_weight'))) !!}
                                        <div class="input-group-append">
                                            <label class="input-group-text" for="name">
                            ...
                            <div class="row align-items-center">
                                <div class="col-sm-4 align-self-center">
                                    <div class="form-group has-feedback row {{ $errors->has('length') ? ' has-error ' : '' }}">
                                        {!! Form::label('length', 'L', array('class' => 'col-md-1 control-label')); !!}
                                            <div class="col-md-10">
                                            <div class="input-group">
                                                {!! Form::text('length',  old('legnth'), array('id' => 'length', 'class' => 'form-control', 'placeholder' => trans('forms.create_product_ph_length'), 'type' => 'number')) !!}
                                                <div class="input-group-append">
                                ...
                                <div class="col-sm-4 align-self-center">
                                    <div class="form-group has-feedback row {{ $errors->has('width') ? ' has-error ' : '' }}">
                                        ...
                                        <div class="col-md-10">
                                            <div class="input-group">
                                                {!! Form::text('width',  old('width'), array('id' => 'width', 'class' => 'form-control', 'placeholder' => trans('forms.create_product_ph_width'), 'type' => 'number')) !!}
                                                <div class="input-group-append">
                                ...
                                <div class="col-sm-4 align-self-center">
                                    <div class="form-group has-feedback row {{ $errors->has('height') ? ' has-error ' : '' }}">
                                        ...
                                        <div class="col-md-10">
                                            <div class="input-group">
                                                {!! Form::text('height',  old('height'), array('id' => 'height', 'class' => 'form-control', 'placeholder' => trans('forms.create_product_ph_height'), 'type' => 'number')) !!}
                                                <div class="input-group-append">
                                ...
                                <div class="col-sm-12 align-self-center">
                                    <div class="form-group has-feedback row {{ $errors->has('cartonsize') ? ' has-error ' : '' }}">
                                        ...
                                        <div class="col align-self-center">
                                            <div class="input-group">
                                                {!! Form::text('cartonsize', old('cartonsize'), array('id' => 'cartonsize', 'readonly' => 'true', 'class' => 'form-control', 'placeholder' => trans('forms.create_product_ph_cartonsize'))) !!}
                                                <div class="input-group-append">
                    ...
                    <div class="card card-info">
                        ...
                        <div class="card-body">
                            <div class="form-group has-feedback row {{ $errors->has('package_units') ? ' has-error ' : '' }}">
                                ...
                                <div class="col align-self-center">
                                    <div class="input-group">
                                        {!! Form::number('package_units', old('package_units'), array('id' => 'package_units', 'class' => 'form-control', 'placeholder' => trans('forms.create_product_ph_package_units'), 'required')) !!}
                                        <div class="input-group-append">
                            ...
                            <div class="form-group has-feedback row {{ $errors->has('package_box') ? ' has-error ' : '' }}">
                                ...
                                <div class="col align-self-center">
                                    <div class="input-group">
                                        {!! Form::number('package_box', old('package_box'), array('id' => 'package_box', 'class' => 'form-control', 'placeholder' => trans('forms.create_product_ph_package_box'), 'required')) !!}
                                        <div class="input-group-append">
                            ...
                            <div class="form-group has-feedback row {{ $errors->has('box_units') ? ' has-error ' : '' }}">
                                ...
                                <div class="col align-self-center">
                                    <div class="input-group">
                                        {!! Form::number('box_units', old('box_units'), array('id' => 'box_units', 'class' => 'form-control', 'placeholder' => trans('forms.create_product_ph_box_units'), 'required')) !!}
                                        <div class="input-group-append">
                            ...
                            <div class="form-group has-feedback row {{ $errors->has('box_litter') ? ' has-error ' : '' }}">
                                ...
                                <div class="col align-self-center">
                                    <div class="input-group">
                                        {!! Form::number('box_litter', old('box_litter'), array('id' => 'box_litter', 'class' => 'form-control', 'placeholder' => trans('forms.create_product_ph_box_litter'), 'required')) !!}
                                        <div class="input-group-append">
                            ...
                            <div class="form-group has-feedback row {{ $errors->has('platform_litter') ? ' has-error ' : '' }}">
                                ...
                                <div class="col align-self-center">
                                    <div class="input-group">
                                        {!! Form::number('platform_litter', old('platform_litter'), array('id' => 'platform_litter', 'class' => 'form-control', 'placeholder' => trans('forms.create_product_ph_platform_litter'), 'required')) !!}
                                        <div class="input-group-append">
                            ...
                            <div class="form-group has-feedback row {{ $errors->has('dunnage_size') ? ' has-error ' : '' }}">
                                ...
                                <div class="col align-self-center">
                                    <div class="input-group">
                                        {!! Form::number('dunnage_size', old('dunnage_size'), array('id' => 'dunnage_size', 'class' => 'form-control', 'placeholder' => trans('forms.create_product_ph_dunnage_size'), 'required')) !!}
                                        <div class="input-group-append">
                        ...
                        <div class="row align-items-center">
                            <div class="col-sm-6 align-self-center">
                                <div class="form-group has-feedback row {{ $errors->has('time_production') ? ' has-error ' : '' }}">
                                    ...
                                    <div class="col align-self-center">
                                        <div class="input-group">
                                            {!! Form::number('time_production', old('time_production'), array('id' => 'time_production', 'class' => 'form-control', 'placeholder' => trans('forms.create_product_ph_time_production'), 'required')) !!}
                                            <div class="input-group-append">
            ...
            <div class="row align-items-center">
                <div class="col-sm-12">
                    {!! Form::button(trans('forms.save-create'), array('class' => 'btn btn-success margin-bottom-1 mb-1 float-right','type' => 'submit' )) !!}
                    {!! Form::close() !!}
                </div>
            </div>
        </div>
